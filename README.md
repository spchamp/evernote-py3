...
Evernote API version 1.28 (unofficial, unsupported fork)

This SDK is intended for use with Python 3

For Python 2, please refer to the official Evernote Python SDK:
